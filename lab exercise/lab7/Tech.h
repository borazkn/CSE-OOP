...
public:
    ...
    Tech(std::string _productCode, std::string _brand, double _price, std::string _name, int _stock, float _weight, float _chargingTime, std::string _connectivity):Product(_productCode, _brand, _price, _name, _stock){
